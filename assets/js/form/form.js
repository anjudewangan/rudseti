...
// Assignment Form
$(".call-answered-yes").hide();
$(".call-answered-no").hide();
$(".information-not-provided").hide();
$(".show-editable-fields").hide();
$("#call-answered-yes").click(function () {
    $(".call-answered-yes").show();
    $(".call-answered-no").hide();
});

$("#call-answered-no").click(function () {
    $(".call-answered-no").show();
    $(".call-answered-yes").hide();
});

$("#information-not-provided").click(function () {
    $(".information-not-provided").show();
    $(".show-editable-fields").hide();
});

$("#information-provided").click(function () {
    $(".information-not-provided").hide();
    $(".show-editable-fields").hide();
});
...
$('#menu-select').change(function () {
    ...
    if (selectedValue === 'directorChanged') {
        $('.show-editable-fields').show();
    } else {
        $('.show-editable-fields').hide();
    }
});
