...
// Status Options
$(".remarks").hide();
$('#optionselect1').on('change', function () {
    var demovalue = $(this).val();
    $("div.remarks1").hide();
    $("#show1" + demovalue).show();
});

$('#optionselect2').on('change', function () {
    var demovalue = $(this).val();
    $("div.remarks2").hide();
    $("#show2" + demovalue).show();
});

$('#optionselect3').on('change', function () {
    var demovalue = $(this).val();
    $("div.remarks3").hide();
    $("#show3" + demovalue).show();
});

$('#optionselect4').on('change', function () {
    var demovalue = $(this).val();
    $("div.remarks4").hide();
    $("#show4" + demovalue).show();
});

$('#optionselect5').on('change', function () {
    var demovalue = $(this).val();
    $("div.remarks5").hide();
    $("#show5" + demovalue).show();
});

$('#optionselect6').on('change', function () {
    var demovalue = $(this).val();
    $("div.remarks6").hide();
    $("#show6" + demovalue).show();
});
